...
| Prototype deployment is mistaken for operational approval | Payments or activities open without accountable human review | Public G1–G9 register remains blocked unless all 12 required gates carry unexpired public evidence; validator ties operational activation to the complete gate set | Named owners must review and publish non-sensitive evidence for every gate |
